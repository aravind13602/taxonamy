// // Load the JSON data and find nearby districts
...
//     try {
//         // Step 1: Load the JSON file with district data
//         const response = await fetch("districts.json");
//         const districtsData = await response.json();

//         // Step 2: Find the searched district in the data
...
//         const { lat: districtLat, lon: districtLon } = searchedDistrict;
//         console.log(`Coordinates for ${searchDistrict}:`, districtLat, districtLon);

//         // Step 3: Calculate distances for all districts
...
//             listItem.textContent = `${district.district}, ${district.state} (Distance: ${district.distance.toFixed(
//                 2
//             )} km)`;
...
//     }
// });
// Function to fetch and sort districts based on proximity
async function fetchSortedDistricts(searchDistrict) {
    const statusElement = document.getElementById("status");
    const districtListElement = document.getElementById("districtList");
